...
* If you want to run it from the command line,follow these instructions:
  ...
  b. Go in the directory where is the sample, for example: ``` cd "\Users\cyrille\Documents\Visual Studio 2015\Projects\forge-api-dotnet-client\samples\simple-csharp" ```
  c. If you built the Release version, type: ``` simple-csharp\bin\Release\forge.simple-csharp ```
