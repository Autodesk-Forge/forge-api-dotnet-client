...
* If you want to run it from the command line,follow these instructions:
  ...
  b. Go in the directory where is the sample, for example: ``` cd "\Users\cyrille\Documents\Visual Studio 2015\Projects\forge-api-dotnet-client\samples\3legged-vb" ```
  c. If you built the Release version, type: ``` 3legged-vb\bin\Release\forge.3legged-vb ```
