...
mono nuget.exe install src/Autodesk.Forge/packages.config -o packages;
...
-target:library \
-out:bin/Autodesk.Forge.dll \
-recurse:'src/Autodesk.Forge/*.cs' \
-doc:bin/Autodesk.Forge.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Autodesk.Forge.dll was created successfully"
fi
