...
namespace Autodesk.Forge {
	...
	public partial class DerivativesApi : IDerivativesApi {
		...
		public ApiResponse< /*Result*/dynamic> DeleteManifestWithHttpInfo (string urn) {
			...
			if ( urn != null )
				localVarPathParams.Add ("urn", Configuration.ApiClient.ParameterToString (urn)); // path parameter
		...
		public ApiResponse</*System.IO.Stream*/dynamic> GetDerivativeManifestWithHttpInfo (string urn, string derivativeUrn, string range = null, string acceptEncoding = null) {
			...
			if ( urn != null )
				localVarPathParams.Add ("urn", Configuration.ApiClient.ParameterToString (urn)); // path parameter
			if ( derivativeUrn != null )
				localVarPathParams.Add ("derivativeUrn", Configuration.ApiClient.ParameterToString (derivativeUrn)); // path parameter
			if ( range != null )
		...
		public ApiResponse< /*Metadata*/dynamic> GetModelviewMetadataWithHttpInfo (string urn, string guid, string acceptEncoding = null, bool xAdsForce = false, bool forceget = false) {
			...
			if ( urn != null )
				localVarPathParams.Add ("urn", Configuration.ApiClient.ParameterToString (urn)); // path parameter
			if ( guid != null )
				localVarPathParams.Add ("guid", Configuration.ApiClient.ParameterToString (guid)); // path parameter
			if ( acceptEncoding != null )
				localVarHeaderParams.Add ("Accept-Encoding", Configuration.ApiClient.ParameterToString (acceptEncoding)); // header parameter
			if ( xAdsForce != false )
		...
		public ApiResponse< /*System.IO.Stream*/dynamic> GetThumbnailWithHttpInfo (string urn, int? width = null, int? height = null) {
			...
			if ( urn != null )
				localVarPathParams.Add ("urn", Configuration.ApiClient.ParameterToString (urn)); // path parameter
			if ( width != null )
				localVarQueryParams.Add ("width", Configuration.ApiClient.ParameterToString (width)); // query parameter
			if ( height != null )
				localVarQueryParams.Add ("height", Configuration.ApiClient.ParameterToString (height)); // query parameter
		...
		public async System.Threading.Tasks.Task<ApiResponse</*Job*/dynamic>> TranslateAsyncWithHttpInfo (JobPayload job, bool? xAdsForce = null) {
			...
			localVarPathParams.Add ("format", "json");
			if ( xAdsForce != null )
				localVarHeaderParams.Add ("x-ads-force", Configuration.ApiClient.ParameterToString (xAdsForce).ToLower ()); // header parameter
			if ( job != null && job.GetType () == typeof (byte []) ) // http body (model) parameter
			{
				localVarPostBody = job; // byte array
			} else if ( job != null
