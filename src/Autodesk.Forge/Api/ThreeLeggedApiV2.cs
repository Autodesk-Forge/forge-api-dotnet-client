...
namespace Autodesk.Forge.Api
{
	...
	public interface IThreeLeggedApi : IApiAccessor
	{
		...
		/*Bearer*/
		dynamic Gettoken(string clientId, string clientSecret, string grantType, string code, string redirectUri);
		...
		/// <returns>Bearer</returns>
		/*Bearer*/
		dynamic Refreshtoken(string clientId, string clientSecret, string grantType, string refreshToken, Scope[] scope = null);
	...
	/// Represents a collection of functions to interact with the API endpoints
	/// </summary>
	public partial class ThreeLeggedApiV2 : IThreeLeggedApi
	{
		...
		/// </summary>
		/// <returns></returns>
		public ThreeLeggedApiV2(String basePath)
		{
		...
		/// <returns></returns>
		public ThreeLeggedApiV2(Configuration configuration = null)
		{
