...
namespace Autodesk.Forge
{
    ...
    public interface IObjectsApi : IApiAccessor
    {
        ...
        /// <returns>ObjectDetails</returns>
        /*ObjectDetails*/dynamic UploadChunk (string bucketKey, string objectName, int? contentLength, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null);
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ApiResponse of ObjectDetails</returns>
        ApiResponse</*ObjectDetails*/dynamic> UploadChunkWithHttpInfo (string bucketKey, string objectName, int? contentLength, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ObjectDetails</returns>
        /*ObjectDetails*/dynamic UploadObject (string bucketKey, string objectName, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null);
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ApiResponse of ObjectDetails</returns>
        ApiResponse</*ObjectDetails*/dynamic> UploadObjectWithHttpInfo (string bucketKey, string objectName, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ObjectDetails</returns>
        /*ObjectDetails*/dynamic UploadSignedResource (string id, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null, string ifMatch = null);
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ApiResponse of ObjectDetails</returns>
        ApiResponse</*ObjectDetails*/dynamic> UploadSignedResourceWithHttpInfo (string id, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null, string ifMatch = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="xAdsRegion">The region where the bucket resides Acceptable values: &#x60;US&#x60;, &#x60;EMEA&#x60; Default is &#x60;US&#x60;  (optional, default to US)</param>
        /// <returns>ObjectDetails</returns>
        /*ObjectDetails*/dynamic UploadSignedResourcesChunk (string id, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null);
        ...
        /// <param name="xAdsRegion">The region where the bucket resides Acceptable values: &#x60;US&#x60;, &#x60;EMEA&#x60; Default is &#x60;US&#x60;  (optional, default to US)</param>
        /// <returns>ApiResponse of ObjectDetails</returns>
        ApiResponse</*ObjectDetails*/dynamic> UploadSignedResourcesChunkWithHttpInfo (string id, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null);
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ObjectDetails</returns>
        System.Threading.Tasks.Task</*ObjectDetails*/dynamic> UploadChunkAsync (string bucketKey, string objectName, int? contentLength, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null);
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ApiResponse (ObjectDetails)</returns>
        System.Threading.Tasks.Task<ApiResponse</*ObjectDetails*/dynamic>> UploadChunkAsyncWithHttpInfo (string bucketKey, string objectName, int? contentLength, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ObjectDetails</returns>
        System.Threading.Tasks.Task</*ObjectDetails*/dynamic> UploadObjectAsync (string bucketKey, string objectName, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null);
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ApiResponse (ObjectDetails)</returns>
        System.Threading.Tasks.Task<ApiResponse</*ObjectDetails*/dynamic>> UploadObjectAsyncWithHttpInfo (string bucketKey, string objectName, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ObjectDetails</returns>
        System.Threading.Tasks.Task</*ObjectDetails*/dynamic> UploadSignedResourceAsync (string id, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null, string ifMatch = null);
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ApiResponse (ObjectDetails)</returns>
        System.Threading.Tasks.Task<ApiResponse</*ObjectDetails*/dynamic>> UploadSignedResourceAsyncWithHttpInfo (string id, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null, string ifMatch = null);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="xAdsRegion">The region where the bucket resides Acceptable values: &#x60;US&#x60;, &#x60;EMEA&#x60; Default is &#x60;US&#x60;  (optional, default to US)</param>
        /// <returns>Task of ObjectDetails</returns>
        System.Threading.Tasks.Task</*ObjectDetails*/dynamic> UploadSignedResourcesChunkAsync (string id, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null);
        ...
        /// <param name="xAdsRegion">The region where the bucket resides Acceptable values: &#x60;US&#x60;, &#x60;EMEA&#x60; Default is &#x60;US&#x60;  (optional, default to US)</param>
        /// <returns>Task of ApiResponse (ObjectDetails)</returns>
        System.Threading.Tasks.Task<ApiResponse</*ObjectDetails*/dynamic>> UploadSignedResourcesChunkAsyncWithHttpInfo (string id, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null);
    ...
    public partial class ObjectsApi : IObjectsApi
    {
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ObjectDetails</returns>
        public /*ObjectDetails*/dynamic UploadChunk (string bucketKey, string objectName, int? contentLength, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null)
        {
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ApiResponse of ObjectDetails</returns>
        public ApiResponse< /*ObjectDetails*/dynamic > UploadChunkWithHttpInfo (string bucketKey, string objectName, int? contentLength, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null)
        {
            // verify the required parameter 'bucketKey' is set
            if (bucketKey == null)
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ObjectDetails</returns>
        public async System.Threading.Tasks.Task</*ObjectDetails*/dynamic> UploadChunkAsync (string bucketKey, string objectName, int? contentLength, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null)
        {
             ApiResponse</*ObjectDetails*/dynamic> localVarResponse = await UploadChunkAsyncWithHttpInfo(bucketKey, objectName, contentLength, contentRange, sessionId, body, contentType, contentDisposition, ifMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ApiResponse (ObjectDetails)</returns>
        public async System.Threading.Tasks.Task<ApiResponse</*ObjectDetails*/dynamic>> UploadChunkAsyncWithHttpInfo (string bucketKey, string objectName, int? contentLength, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null)
        {
            // verify the required parameter 'bucketKey' is set
            if (bucketKey == null)
                throw new ApiException(400, "Missing required parameter 'bucketKey' when calling ObjectsApi->UploadChunk");
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ObjectDetails</returns>
        public /*ObjectDetails*/dynamic UploadObject (string bucketKey, string objectName, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null)
        {
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ApiResponse of ObjectDetails</returns>
        public ApiResponse< /*ObjectDetails*/dynamic > UploadObjectWithHttpInfo (string bucketKey, string objectName, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null)
        {
            // verify the required parameter 'bucketKey' is set
            if (bucketKey == null)
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ObjectDetails</returns>
        public async System.Threading.Tasks.Task</*ObjectDetails*/dynamic> UploadObjectAsync (string bucketKey, string objectName, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null)
        {
             ApiResponse</*ObjectDetails*/dynamic> localVarResponse = await UploadObjectAsyncWithHttpInfo(bucketKey, objectName, contentLength, body, contentType, contentDisposition, ifMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ApiResponse (ObjectDetails)</returns>
        public async System.Threading.Tasks.Task<ApiResponse</*ObjectDetails*/dynamic>> UploadObjectAsyncWithHttpInfo (string bucketKey, string objectName, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string ifMatch = null)
        {
            // verify the required parameter 'bucketKey' is set
            if (bucketKey == null)
                throw new ApiException(400, "Missing required parameter 'bucketKey' when calling ObjectsApi->UploadObject");
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ObjectDetails</returns>
        public /*ObjectDetails*/dynamic UploadSignedResource (string id, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null, string ifMatch = null)
        {
             ApiResponse</*ObjectDetails*/dynamic> localVarResponse = UploadSignedResourceWithHttpInfo(id, contentLength, body, contentType, contentDisposition, xAdsRegion, ifMatch);
             return localVarResponse.Data;
        }
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>ApiResponse of ObjectDetails</returns>
        public ApiResponse< /*ObjectDetails*/dynamic > UploadSignedResourceWithHttpInfo (string id, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null, string ifMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ObjectDetails</returns>
        public async System.Threading.Tasks.Task</*ObjectDetails*/dynamic> UploadSignedResourceAsync (string id, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null, string ifMatch = null)
        {
             ApiResponse</*ObjectDetails*/dynamic> localVarResponse = await UploadSignedResourceAsyncWithHttpInfo(id, contentLength, body, contentType, contentDisposition, xAdsRegion, ifMatch);
             return localVarResponse.Data;
        ...
        /// <param name="ifMatch">If-Match header containing a SHA-1 hash of the bytes in the request body can be sent by the calling service or client application with the request. If present, OSS will use the value of If-Match header to verify that a SHA-1 calculated for the uploaded bytes server side matches what was sent in the header. If not, the request is failed with a status 412 Precondition Failed and the data is not written.  (optional)</param>
        /// <returns>Task of ApiResponse (ObjectDetails)</returns>
        public async System.Threading.Tasks.Task<ApiResponse</*ObjectDetails*/dynamic>> UploadSignedResourceAsyncWithHttpInfo (string id, int? contentLength, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null, string ifMatch = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ObjectsApi->UploadSignedResource");
        ...
        /// <param name="xAdsRegion">The region where the bucket resides Acceptable values: &#x60;US&#x60;, &#x60;EMEA&#x60; Default is &#x60;US&#x60;  (optional, default to US)</param>
        /// <returns>ObjectDetails</returns>
        public /*ObjectDetails*/dynamic UploadSignedResourcesChunk (string id, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null)
        {
             ApiResponse</*ObjectDetails*/dynamic> localVarResponse = UploadSignedResourcesChunkWithHttpInfo(id, contentRange, sessionId, body, contentType, contentDisposition, xAdsRegion);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xAdsRegion">The region where the bucket resides Acceptable values: &#x60;US&#x60;, &#x60;EMEA&#x60; Default is &#x60;US&#x60;  (optional, default to US)</param>
        /// <returns>ApiResponse of ObjectDetails</returns>
        public ApiResponse< /*ObjectDetails*/dynamic > UploadSignedResourcesChunkWithHttpInfo (string id, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="xAdsRegion">The region where the bucket resides Acceptable values: &#x60;US&#x60;, &#x60;EMEA&#x60; Default is &#x60;US&#x60;  (optional, default to US)</param>
        /// <returns>Task of ObjectDetails</returns>
        public async System.Threading.Tasks.Task</*ObjectDetails*/dynamic> UploadSignedResourcesChunkAsync (string id, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null)
        {
             ApiResponse</*ObjectDetails*/dynamic> localVarResponse = await UploadSignedResourcesChunkAsyncWithHttpInfo(id, contentRange, sessionId, body, contentType, contentDisposition, xAdsRegion);
             return localVarResponse.Data;
        ...
        /// <param name="xAdsRegion">The region where the bucket resides Acceptable values: &#x60;US&#x60;, &#x60;EMEA&#x60; Default is &#x60;US&#x60;  (optional, default to US)</param>
        /// <returns>Task of ApiResponse (ObjectDetails)</returns>
        public async System.Threading.Tasks.Task<ApiResponse</*ObjectDetails*/dynamic>> UploadSignedResourcesChunkAsyncWithHttpInfo (string id, string contentRange, string sessionId, System.IO.Stream body, string contentType = "application/octet-stream", string contentDisposition = null, string xAdsRegion = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ObjectsApi->UploadSignedResourcesChunk");
