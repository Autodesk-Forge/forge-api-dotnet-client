...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Versions :  IEquatable<Versions>
    {
        /// <summary>
        ...
        public Versions(JsonApiVersionJsonapi Jsonapi = null, List<Version> Data = null)
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for Versions and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Versions);
        }

        /// <summary>
        /// Returns true if Versions instances are equal
        /// </summary>
        /// <param name="other">Instance of Versions to be compared</param>
        /// <returns>Boolean</returns>
