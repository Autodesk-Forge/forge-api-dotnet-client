...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateStorage :  IEquatable<CreateStorage>
    {
        /// <summary>
        ...
        public CreateStorageData Data { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateStorage);
        }

        /// <summary>
        /// Returns true if CreateStorage instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateStorage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateStorage other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
