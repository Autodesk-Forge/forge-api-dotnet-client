...
namespace Autodesk.Forge.Model
{
    ...
    public partial class Result :  IEquatable<Result>
    {
        ...
        /// Initializes a new instance of the <see cref="Result" /> class.
        /// </summary>
        /// <param name="_Result">_Result (required).</param>
        public Result(string _Result = null)
        {
            // to ensure "_Result" is required (not null)
            if (_Result == null)
            {
                throw new InvalidDataException("_Result is a required property for Result and cannot be null");
            }
            else
            {
