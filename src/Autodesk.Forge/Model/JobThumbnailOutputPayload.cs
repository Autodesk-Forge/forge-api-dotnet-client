...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobThumbnailOutputPayload :  IEquatable<JobThumbnailOutputPayload>
    {
        /// <summary>
        ...
        public JobThumbnailOutputPayloadAdvanced Advanced { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="JobThumbnailOutputPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JobThumbnailOutputPayload() { }
        ...
        public JobThumbnailOutputPayload(TypeEnum? Type = null, JobThumbnailOutputPayloadAdvanced Advanced = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for JobThumbnailOutputPayload and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobThumbnailOutputPayload {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JobThumbnailOutputPayload);
        }

        /// <summary>
        /// Returns true if JobThumbnailOutputPayload instances are equal
        /// </summary>
        /// <param name="other">Instance of JobThumbnailOutputPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobThumbnailOutputPayload other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
