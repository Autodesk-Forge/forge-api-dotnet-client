...
namespace Autodesk.Forge.Model {
	...
	public partial class JobPayloadMisc : IEquatable<JobPayloadMisc> {
		...
		public JobPayloadMisc (string Workflow = null, object WorkflowAttribute = null) {
		...
		public override string ToString () {
			...
			sb.Append ("  WorkflowAttribute: ").Append (WorkflowAttribute).Append ("\n");
			sb.Append ("}\n");
			return (sb.ToString ());
		}
		...
		public bool Equals (JobPayloadMisc other) {
			...
			return (
				...
				&&
				(
					this.WorkflowAttribute == other.WorkflowAttribute ||
					this.WorkflowAttribute != null &&
					this.WorkflowAttribute.Equals (other.WorkflowAttribute)
				)
			);
		}
		...
		public override int GetHashCode () {
			...
			unchecked // Overflow is fine, just wrap
			{
				...
				if ( this.WorkflowAttribute != null )
					hash = hash * 59 + this.WorkflowAttribute.GetHashCode ();
				return (hash);
			}
		}
