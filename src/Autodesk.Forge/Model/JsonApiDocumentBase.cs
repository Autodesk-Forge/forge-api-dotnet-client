...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JsonApiDocumentBase :  IEquatable<JsonApiDocumentBase>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonApiDocumentBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JsonApiDocumentBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonApiDocumentBase" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JsonApiDocumentBase);
        }

        /// <summary>
        /// Returns true if JsonApiDocumentBase instances are equal
        /// </summary>
        /// <param name="other">Instance of JsonApiDocumentBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonApiDocumentBase other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
