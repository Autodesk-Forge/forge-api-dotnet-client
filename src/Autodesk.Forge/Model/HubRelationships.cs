...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HubRelationships :  IEquatable<HubRelationships>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HubRelationships" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HubRelationships() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HubRelationships" /> class.
        /// </summary>
        ...
        public JsonApiRelationshipsLinksInternal Projects { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HubRelationships {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HubRelationships);
        }

        /// <summary>
        /// Returns true if HubRelationships instances are equal
        /// </summary>
        /// <param name="other">Instance of HubRelationships to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HubRelationships other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
