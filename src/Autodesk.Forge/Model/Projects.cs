...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Projects :  IEquatable<Projects>
    {
        /// <summary>
        ...
        public Projects(JsonApiVersionJsonapi Jsonapi = null, List<Project> Data = null)
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for Projects and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Projects);
        }

        /// <summary>
        /// Returns true if Projects instances are equal
        /// </summary>
        /// <param name="other">Instance of Projects to be compared</param>
        /// <returns>Boolean</returns>
