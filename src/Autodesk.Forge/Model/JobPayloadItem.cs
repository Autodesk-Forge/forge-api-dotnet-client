...
namespace Autodesk.Forge.Model
{
    ...
    public partial class JobPayloadItem : IEquatable<JobPayloadItem>
    {
        ...
        public JobPayloadItem(TypeEnum? Type = null, List<ViewsEnum> Views = null, IJobPayloadItemAdvanced Advanced = null)
        {
            ...
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for JobPayloadItem and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JobPayloadItem);
        }

        /// <summary>
        /// Returns true if JobPayloadItem instances are equal
        /// </summary>
        /// <param name="other">Instance of JobPayloadItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobPayloadItem other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
