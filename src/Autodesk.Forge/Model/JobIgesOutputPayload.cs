...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JobIgesOutputPayload :  IEquatable<JobIgesOutputPayload>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JobIgesOutputPayload" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JobIgesOutputPayload() { }
        ...
        public JobIgesOutputPayload(TypeEnum? Type = null, JobIgesOutputPayloadAdvanced Advanced = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for JobIgesOutputPayload and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public JobIgesOutputPayloadAdvanced Advanced { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobIgesOutputPayload {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JobIgesOutputPayload);
        }

        /// <summary>
        /// Returns true if JobIgesOutputPayload instances are equal
        /// </summary>
        /// <param name="other">Instance of JobIgesOutputPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobIgesOutputPayload other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
