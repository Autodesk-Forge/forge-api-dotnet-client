...
namespace Autodesk.Forge.Model
{
    ...
    public partial class PostBucketsSigned :  IEquatable<PostBucketsSigned>
    {
        ...
        public PostBucketsSigned(int? MinutesExpiration = null)
        {
            // to ensure "MinutesExpiration" is required (not null)
            if (MinutesExpiration == null)
            {
                throw new InvalidDataException("MinutesExpiration is a required property for PostBucketsSigned and cannot be null");
            }
            else
            {
