...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Conflict :  IEquatable<Conflict>
    {
        /// <summary>
        ...
        public Conflict(JsonApiVersionJsonapi Jsonapi = null, List<JsonApiErrorErrors> Errors = null)
        {
            // to ensure "Errors" is required (not null)
            if (Errors == null)
            {
                throw new InvalidDataException("Errors is a required property for Conflict and cannot be null");
            }
            else
            {
                this.Errors = Errors;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Conflict);
        }

        /// <summary>
        /// Returns true if Conflict instances are equal
        /// </summary>
        /// <param name="other">Instance of Conflict to be compared</param>
        /// <returns>Boolean</returns>
