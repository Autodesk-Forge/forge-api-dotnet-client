...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemCreated :  IEquatable<ItemCreated>
    {
        /// <summary>
        ...
        public ItemCreated(JsonApiVersionJsonapi Jsonapi = null, Item Data = null, List<JsonApiResource> Included = null, JsonApiLinksSelf Links = null)
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for ItemCreated and cannot be null");
            }
            else
            {
                this.Data = Data;
            ...
            if (Links == null)
            {
                throw new InvalidDataException("Links is a required property for ItemCreated and cannot be null");
            }
            else
            {
                this.Links = Links;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ItemCreated);
        }

        /// <summary>
        /// Returns true if ItemCreated instances are equal
        /// </summary>
        /// <param name="other">Instance of ItemCreated to be compared</param>
        /// <returns>Boolean</returns>
