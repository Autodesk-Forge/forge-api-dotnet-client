...
namespace Autodesk.Forge.Model.DesignAutomation.v3
{
    ...
    public partial class PageAlias :  IEquatable<PageAlias>
    {
        /// <summary>
        ...
        public PageAlias(string PaginationToken = null, List<Alias> Data = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageAlias);
        }

        /// <summary>
        /// Returns true if PageAlias instances are equal
        /// </summary>
        /// <param name="other">Instance of PageAlias to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageAlias other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
