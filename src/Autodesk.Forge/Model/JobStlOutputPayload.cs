...
namespace Autodesk.Forge.Model
{
    ...
    public partial class JobStlOutputPayload :  IEquatable<JobStlOutputPayload>
    {
        ...
        public JobStlOutputPayload(TypeEnum? Type = null, JobStlOutputPayloadAdvanced Advanced = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for JobStlOutputPayload and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JobStlOutputPayload);
        }

        /// <summary>
        /// Returns true if JobStlOutputPayload instances are equal
        /// </summary>
        /// <param name="other">Instance of JobStlOutputPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobStlOutputPayload other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
