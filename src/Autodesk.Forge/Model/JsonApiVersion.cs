...
namespace Autodesk.Forge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class JsonApiVersion :  IEquatable<JsonApiVersion>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as JsonApiVersion);
        }

        /// <summary>
        /// Returns true if JsonApiVersion instances are equal
        /// </summary>
        /// <param name="other">Instance of JsonApiVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonApiVersion other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
