...
rm src/IO.Swagger.Test/bin/Debug/Autodesk.Forge.Test.dll 2> /dev/null
...
xbuild Autodesk.Forge.sln && \
    mono ./packages/NUnit.Runners.2.6.4/tools/nunit-console.exe src/Autodesk.Forge.Test/bin/Debug/Autodesk.Forge.Test.dll
